...
from DPG_modules.Addons import get_alpha_theme, get_text_size, ImageSizeInput
...
class ImagesToPDFListCell(ImageListCell):
    ...
    def __init__(self, image_list: 'ImageList', image_store: ImagesToPDFStorage, settings: LoadSettings):
