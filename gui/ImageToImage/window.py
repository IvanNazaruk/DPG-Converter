...
from DPG_modules.Addons import CheckBoxSlider, ComboList, ImageSizeInput
from DPG_modules.Addons import context_manager_decorator
from .image_table_cell import ImageToImageListCell
from .image_table_cell import LoadSettings
...
class Window(AddFileTab):
            ...
            with dpg.table(header_row=False, clipper=True):
                ...
                with dpg.table_row():
                    with dpg.group(horizontal=True):
                        ...
                        self.auto_start_check_box.create(True)
    ...
    def add_file(self, file_path: Path):
        ...
        cell = ImageToImageListCell(self.image_list, image_store, self.settings)
