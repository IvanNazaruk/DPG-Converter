...
colors: dict[int, Sequence[int, int, int, Optional[int]]] = {
    dpg.mvThemeCol_Text: [191, 191, 191, 255],
    dpg.mvThemeCol_TextDisabled: [89, 89, 89, 255],
    dpg.mvThemeCol_WindowBg: [0, 0, 0, 239],
    dpg.mvThemeCol_ChildBg: [0, 0, 0, 239],
    dpg.mvThemeCol_PopupBg: [0, 0, 0, 239],
    dpg.mvThemeCol_Border: [0, 0, 0, 127],
    dpg.mvThemeCol_BorderShadow: [0, 0, 0, 0],
    dpg.mvThemeCol_FrameBg: [0, 0, 0, 137],
    dpg.mvThemeCol_FrameBgHovered: [94, 35, 35, 170],
    dpg.mvThemeCol_FrameBgActive: [99, 51, 51, 170],
    dpg.mvThemeCol_TitleBg: [10, 10, 10, 255],
    dpg.mvThemeCol_TitleBgActive: [122, 40, 40, 255],
    dpg.mvThemeCol_TitleBgCollapsed: [122, 40, 40, 255],
    ...
    dpg.mvThemeCol_CheckMark: [142, 25, 25, 255],
    dpg.mvThemeCol_SliderGrab: [255, 48, 48, 102],
    dpg.mvThemeCol_SliderGrabActive: [226, 0, 48, 255],
    dpg.mvThemeCol_Button: [255, 48, 48, 102],
    dpg.mvThemeCol_ButtonHovered: [204, 43, 0, 255],
    dpg.mvThemeCol_ButtonActive: [226, 0, 48, 255],
    dpg.mvThemeCol_Header: [84, 89, 91, 135],
    dpg.mvThemeCol_HeaderHovered: [193, 71, 112, 170],
    dpg.mvThemeCol_HeaderActive: [119, 119, 119, 170],
    dpg.mvThemeCol_Separator: [81, 81, 81, 255],
    dpg.mvThemeCol_SeparatorHovered: [81, 81, 81, 255],
    dpg.mvThemeCol_SeparatorActive: [81, 81, 81, 255],
    ...
    dpg.mvThemeCol_Tab: [17, 17, 17, 130],
    dpg.mvThemeCol_TabHovered: [219, 58, 109, 170],
    dpg.mvThemeCol_TabActive: [48, 48, 48, 145],
    dpg.mvThemeCol_TabUnfocused: [12, 12, 12, 229],
    dpg.mvThemeCol_TabUnfocusedActive: [33, 33, 33, 188],
